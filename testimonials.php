    ...
    <section id="section-2">
      <div class="container">
        <div class="row">
          ...
          <div class="testimonial col-12 col-lg-6" id="testimonial-2">
            <div class="row ">
              <div class="col-12 col-sm-4">
          ...
          <div class="testimonial col-12 col-lg-6" id="testimonial-3">
            <div class="row">
              <div class="col-12 col-sm-4">
          ...
          <div class="testimonial col-12 col-lg-6" id="testimonial-4">
            <div class="row">
              <div class="col-12 col-sm-4">
                <img src="img/image_not_available.png" alt="">
              </div>
              <div class="col-12 col-sm-8">
                <h4 class="text-secondary font-weight-bold">
                  "This is the best company I have ever hired!"
